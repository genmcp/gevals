...
type TestCase struct {
	...
	// Execution mode
	inProcess bool // If true, run gevals in-process instead of subprocess
}
...
// In this mode, the gevals CLI is executed in-process instead of spawning
...
// or if the GEVALS_TEST_INPROCESS environment variable is set to "true".
