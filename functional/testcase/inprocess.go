...
// When set to "true", functional tests will execute the gevals CLI in-process
// instead of spawning a subprocess. This enables code coverage collection and
// IDE debugging with breakpoints.
const EnvInProcessMode = "GEVALS_TEST_INPROCESS"
...
// InProcessExecutor executes the gevals CLI in-process.
...
// Execute runs the gevals CLI in-process and returns the result.
...
func (e *InProcessExecutor) Execute() *InProcessResult {
	...
	os.Args = append([]string{"gevals"}, e.Args...)
